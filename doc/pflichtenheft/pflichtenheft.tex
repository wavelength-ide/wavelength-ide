...
Dabei wird die Auswertung abgebrochen und der Inhalt des Ausgabefeldes gelöscht.
...
Durch Drücken des "Teilen"-Buttons wird die URL in einem Textfeld neben dem Button angezeigt.
...
Weiterhin hat der Nutzer die Möglichkeit, sich durch Drücken eines Buttons die Musterlösung anzeigen zu lassen (siehe \cref{fig:showSolution}). Durch Drücken des selben Buttons wird diese wieder ausgeblendet. \\
