...
Kommentare werden durch "-$\,$-" anstatt "$\backslash\backslash$" markiert 
und die Bezeichnung für einige Bibliotheksfunktionen wurde geändert. 
Die ursprüngliche Spezifikation erlaubte keine doppelte Namensbindung. 
In der finalen Version der Applikation überschatten sich die Namensbindungen.
