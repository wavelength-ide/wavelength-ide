...
\begin{table}[h]
	...
	\begin{tabular}{@{}ll|c|c|c@{}}
		...
		&T5.3 & \xmark & Wurde nur manuell getestet & 1) \\ %TODO Anmerkung in einem Text
		\multicolumn{2}{l|}{\small \textsc{\textbf{T6} Export}} & &\\ 
		&T6.1 - T6.3 & \cmark & \\
		\multicolumn{3}{l|}{\small \textsc{\textbf{T7} Namensbindung}}\\ 
		&T7.1 - T7.2 & \cmark & \\
		&T7.3 & \cmark & Spezifikation für doppelte Namensbindung wurde geändert & 2) \\ %TODO Anmerkung in einem Text
		\multicolumn{4}{l}{\small \textsc{\textbf{T8} Auswahl des Ausgabeumfangs}}\\ 
		&T8.1 - T8.2 & \cmark & \\
		&T8.3 & \xmark & Wurde nur manuell getestet & 3) \\ %TODO Anmerkung in einem Text
