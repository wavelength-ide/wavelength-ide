...
\fulfills{crt:perma}
Die in der Adresszeile des Browsers angezeigte URL kodiert den gesamten Zustand der Sitzung. Dies schließt den Inhalt des Eingabefelds, den Inhalt des Ausgabefeld, den gegenwärtigen Modus und die ausgewählten Optionen mit ein.
Nach jeder Aktion, die den Zustand der IDE verändert, wird auch die angezeigte URL angepasst.\\
...
\teststep{Die Auswertung eines gültigen \gls{lt} wurde begonnen, IDE befindet sich im Step-By-Step Modus}
{Alev drückt den "Play"-Knopf.}
{Das Ausgabefeld ist nicht mehr interaktiv, die IDE wechselt in den Komplettauswertungs-Modus und verhält sich weiterhin wie spezifiziert.}
