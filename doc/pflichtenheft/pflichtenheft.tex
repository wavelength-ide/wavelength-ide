...
{ 
	name=Variable,
	plural=Variablen,
	description={Variablen sind Platzhalter für konkrete Werte. Als Variablen zugelassen sind beliebige Zeichen und Zeichenkombinationen aus $[a-zA-Z0-9\_-]$.\\
	Explizit nicht erlaubt sind Zeichenfolgen mit mindestens einem der folgenden Zeichen:  
	\begin{tabular} {| l | c | c | c | c | c | c | c |r |}
	\hline
	 $\lambda$ & . & \textbackslash & : & = & ( & ) & / \\
	 \hline
	\end{tabular}
	\\ Weiterhin darf eine Variable keine Leerzeichen enthalten.
	Eine Variable darf nicht mit einer Zahl beginnen.
	Die Namen berücksichtigen Groß- und Kleinschreibung.
	}
}
...
\newglossaryentry{nb}
{
	...
	description={Einem \gls{lt} kann ein Name zugewiesen werden. 
		...
		Als Name zugelassen sind alle gültigen Variablen(vgl. \gls{var}).}
}
\newglossaryentry{ex}
{
	name=Übungsaufgabe,
...
\functionality{Export}{fnc:output}
\fulfills{crt:output}
...
\teststep{Der Fokus befindet sich auf dem Fenster mit der formatierten Ausgabe.}
