...
Im Entwurf war vorgesehen folgende Daten in einer Zeichenkette zu speichern: \\
ausgewählte Bibliotheken, Eingabe, Ausgabe, ausgewählte Reduktionsordnung, ausgewähltes Ausgabeformat, ausgewählte Ausgabelänge.
Diese Zeichenkette wird dann zu der Browser URL hinzugefügt.
Diese Zeichenkette kann aber sehr lang werden, da beispielsweise die Eingabe direkt gespeichert wird.
Der Protokollstandard für HTML schreibt zwar die Annahme beliebig langer URLs vor, in der Praxis aber unterstützt kein Browser URLs, die länger als 2.000 Zeichen sind.
Damit 
