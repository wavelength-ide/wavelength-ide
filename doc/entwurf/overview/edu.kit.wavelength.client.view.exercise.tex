...
The \lnk{Exercise} interface specifies that Exercises consist of a name, a task, a solution, (optional) predefined variables and (possibly multiple) test cases.
