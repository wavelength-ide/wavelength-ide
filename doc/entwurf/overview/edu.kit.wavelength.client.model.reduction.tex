...
All reduction orders implement the \texttt{{\lnk{ReductionOrder}}} interface, enabling the \texttt{\hyperref[type:edu.kit.wavelength.client.model.ExecutionEngine]{ExecutionEngine}} to interact with the active reduction order indiscriminately.
