...
{Die Eingabe wird ausgewertet und nur das Ergebnis wird angezeigt.}

\teststep{Die IDE ist bereit für die nächste Aktion}
{Wilhelm wählt in der "Display"-Box eine andere Ausgabelänge aus (vgl. \cref{fig:outputOptions}) und drückt auf den "Start"-Knopf.}
