...
\begin{itemize}
	...
	Der zuletzt ausgewertete \gls{lt} wird ausgegeben, die Anwendung gelangt in den \hyperref[fnc:steps]{Schritt-für-Schritt-Modus} und das \gls{aws}-Dropdown-Menü wird wieder aktiviert.
\end{itemize}
...
\begin{itemize}
	...
	Der erste und zweite \gls{lt} der \gls{lapp} werden als Kindknoten angefügt.
...
\fulfills{crt:cancel}
Durch das Drücken des "Abbrechen"-Knopfes kann der Nutzer während dem Schritt-für-Schritt-Modus und während der Komplettauswertung in den Eingabemodus zurückkehren.\\
...
\teststep{Die IDE ist bereit für die nächste Eingabe.}
{Don wählt das Drop-down-Menü für die \gls{aws} an. Er wählt "\gls{cbn}".}
