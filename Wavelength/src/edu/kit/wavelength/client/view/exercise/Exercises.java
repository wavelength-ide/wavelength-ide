...
public final class Exercises {
	...
	public static List<Exercise> all() {
		...
		String exerciseTask = "The active exercise's task will be displayed here. \n"
				+ " To show a solution to the active exercise press the lightbulb button above.";
		...
		Exercise redex2 = new ConcreteExercise(redexName, redexTask, redexSolution, redexPredef);
		...
		Exercise redex3 = new ConcreteExercise(redexName, redexTask, redexSolution, redexPredef);
