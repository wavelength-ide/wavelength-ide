...
Nach Aufruf der Seite kann ein Nutzer in 3 Schritten einen \gls{lt} nach der \gls{nr} auswerten:
\begin{itemize}
\item \gls{lt} eingeben
\item "Start"-Knopf drücken
\item auf Ende der Auswertung warten
\end{itemize}
