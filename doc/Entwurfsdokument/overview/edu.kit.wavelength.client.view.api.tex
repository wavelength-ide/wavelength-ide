...
\texttt{\pkglnk{view.webui.component}} package implement. This is especially important for
the adapter classes from the \texttt{\pkglnk{view.webui.component}} package.
