...
Lediglich die Tests zur Baum-Ausgabe konnten nicht automatisch durchgeführt werden. %TODO anmerkung im Text
...
%TODO GWT Mockito test cases Problematisch
%TODO Tests laufen nur in JVM aber nicht mit javascript
...
Da wir für die Bäume eine externe JavaScript Bibliothek verwenden, wäre das automatische Testen der Bäume sehr aufwändig bis unmöglich. Aus diesem Grund haben wir uns dazu entschieden die Baumausgabe manuell zu testen (siehe \ref{Baumtests}).
...
\begin{itemize}[itemsep=3ex]
	%TODO vielleicht weiß Marc noch etwas dazu
	%issue 19
	\issue{Die Webworker des Monaco Editors werden nicht korrekt initialisiert.}
	{Fehlende Anweisung in der HTML Datei.}
	{Die Fehlende Anweisung wurde ergänzt.}
\end{itemize}

\subsection{Anzeige betreffend}
%TODO z.B. 46, 45, 42, 28, 24, 5
\begin{itemize}[itemsep=3ex]
