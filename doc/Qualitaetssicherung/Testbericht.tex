...
Da wir für die Bäume eine externe JavaScript Bibliothek verwenden und diese nur Bilder ausgibt, wäre das automatische Testen der Bäume sehr aufwändig bis unmöglich. Aus diesem Grund haben wir uns dazu entschieden die Baumausgabe manuell zu testen (vgl. \ref{Baumtests}).
