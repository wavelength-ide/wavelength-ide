...
\subsection{Kann}
\criteriumOptional{Verfügbarkeit im Browser}{crt:webapp}
...
Die hierzu verwendete \gls{cmpltapp} wird durch das Drücken des grünen Knopfes (\cref{fig:actionButtons}) gestartet. %TODO umbenennung des "grünen Knopfes"
...
%TODO bild und/oder glossar eintrag für ausgabefenster?
Terminiert die Auswertung, wird im Ausgabefenster das Ergebnis im gewählten Ausgabeumfang ausgegeben. %TODO referenz auf Bild
...
\begin{itemize}
	%TODO umbenennung der Knöpfe
	\item Das Drücken des roten Knopfes (\cref{fig:actionButtons}) bricht die \gls{cmpltapp} ab. 
	Anschließend wird der zuletzt berechnete \gls{lt} ausgegeben. Das Drücken des grünen Knopfes hat keine Funktion mehr, bis der Benutzer eine neue Eingabe in das Eingabefeld geschrieben hat oder %TODO Es ist jetzt spät. Lass mal erst auf einen Zustandsautomaten einigen
	\item Das Drücken des pinken Knopfes (\cref{fig:actionButtons}) pausiert die \gls{cmpltapp}. %TODO Step-by-Step-Modus glossary entry
...
\fulfills{crt:awsstrats}
Der Nutzer kann die derzeitig aktive \gls{aws} über ein Drop-down-Menü auswählen. Hierbei kann nur eine \gls{aws} gleichzeitig aktiv sein. Standardmäßig ist die \glslink{nr}{Normal-Reduktionsordnung} ausgewählt. Siehe \cref{fig:outputOptions}
...
\functionality{Verfügbarkeit im Internet}{fnc:webapp}
\fulfills{crt:webapp}
...
%Es wird eine Implementierung mit dem Google Web Toolkit (GWT) angestrebt.
%Dieses unterstützt folgende Browser: Firefox; Internet Explorer 8, 9, 10, 11; Safari 5, 6; Chromium und Google Chrome; Opera in der neuesten Version.
...
%Die vorherigen Schritte werden nicht gespeichert.
%Es ist nicht möglich, diese rückgängig zu machen.
\\
...
% fehlt: \tests{fnc:perma}
% fehlt: \tests{fnc:steps}
