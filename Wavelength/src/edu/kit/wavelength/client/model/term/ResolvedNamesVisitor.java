...
public abstract class ResolvedNamesVisitor<T> implements Visitor<T> {
	 ...
	 * 
	 * @param libraries
	 *            The libraries that are assumed in the ambient context of the terms
	 *            being visited
	 */
	...
	private boolean collides(Set<String> frees, String name) {
		return allAssigned.contains(name) || frees.contains(name)
				|| libraries.stream().anyMatch(l -> l.containsName(name));
	}
	...
	/**
	 * Visit a {@link BoundVariable} with an additional non-colliding name for said
	 * variable.
	 * 
	 ...
	 * @param resolvedName
	 *            The resolved name for the {@link BoundVariable}
	 * @return The return value of the {@link Visitor} upon visiting the given
	 *         {@link BoundVariable}
	 */
	protected abstract T visitBoundVariable(BoundVariable var, String resolvedName);

	/**
	 * Visit an {@link Abstraction} with an additional non-colliding name for its
	 * variable.
	 * 
	 * @param abs
	 *            The {@link Abstraction} to be visited
	 * @param resolvedName
	 *            The resolved name for the variable of this {@link Abstraction}
	 * @return The return value of the visitor upon visiting the given
	 *         {@link Abstraction}
	 */
