package edu.kit.wavelength.client.view.gwtbinding;
...
public class MonacoEditor {
	...
	public static native MonacoEditor load(Panel parent) /*-{
		...
		var c = @edu.kit.wavelength.client.view.gwtbinding.MonacoEditor::config()();
		var editor = $wnd.monaco.editor.create($doc.getElementById(id), c);
		var wrapper = @edu.kit.wavelength.client.view.gwtbinding.MonacoEditor::new()();
		wrapper.@edu.kit.wavelength.client.view.gwtbinding.MonacoEditor::editor = editor;
		return wrapper;
	}-*/;
	
	public native String read() /*-{
		var e = this.@edu.kit.wavelength.client.view.gwtbinding.MonacoEditor::editor;
		return e.getValue();
	}-*/;
