...
\begin{center}
\includegraphics[width=10cm]{img/workflow/alt_running.jpg}\\[0.4cm]

{\Huge $\Downarrow$}\\[0.4cm]

\includegraphics[width=10cm]{img/workflow/neu_running.jpg}\\[0.4cm]
...
\begin{frame}{Fuzzing} % 9 10 16, 11
\begin{itemize}
...
% 59.6 globale Coverage
% 95,8 coverage der getesteten packages
% 70 commits |
\begin{itemize}
