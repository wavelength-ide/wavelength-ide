...
public final class Libraries {
	...
	/**
	 * Returns an unmodifiable list of all libraries known to the
	 * model.
	 * @return An unmodifiable list that contains exactly one instance
	 * of every library known to the model
	 */
