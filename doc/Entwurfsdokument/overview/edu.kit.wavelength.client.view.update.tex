The \texttt{view.update} package contains observer implementations that update the \texttt{\pkglnk{view}}. In the view, observers are primarily used for pushing concurrent updates to the view.
