...
\author[wavelength]
{      Der verantwortliche Entwickler \\
	   \textbf{Sein Surface ist eine Bedrohung für den Rest des Teams} \\
       \textbf{Kann auch keine Commitmessages schreiben} \\
       Eine Bedrohung für den Rest des Teams \\
       Parst nur eine kleine Teilmenge \\ 
       \textbf{Produziert tief genestetes HTML} \\       
}
...
\begin{frame}{$\lambda$-IDE}{}
    ...
    \onslide<2>\includegraphics[scale = 0.22]{img/GUI}
    \end{overprint}
\end{frame}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Benutzbarkeit
			% Tooltips, Infobuttons bei Libraries
		\end{itemize}
