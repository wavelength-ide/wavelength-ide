...
Der Nutzer hat die Möglichkeit, sich Auswertungen v \gls{lt}en in Unicode ausgeben zu lassen. Die Ausgabe wird im Ausgabefeld ausgegeben.\\
...
\fulfills{crt:cancel}
Durch das Drücken des "Abbrechen"-Knopfes (\cref{fig:actionButtons}) kann der Nutzer während dem Schritt-für-Schritt-Modus und während der Komplettauswertung in den Eingabemodus zurückkehren.\\
...
indem an Beginn der Zeile ein '//' eingefügt wird.\\
...
Wählt der Nutzer eine Übung aus, wechselt das Programm in den Übungsmodus. 
...
Hierzu können auch vom Test vorgegeben Platzhalter für Eingaben zählen.\\
Der Nutzer kann anschließend die Aufgabe bearbeiten. 
Wenn er seine Lösung auswerten möchte, werden für die vorher festgelegten Platzhalter konkrete \gls{lt} eingesetzt.
Sobald die Auswertung die \gls{nrmlform} erreicht, wird dem Nutzer ausgegeben, ob sein Ergebnis mit dem erwartete Ergebnis übereinstimmt (siehe \cref{fig:solutionCheck}).\\
...
Alle zur IDE gehörigen Programmcodes, Dokumente, usw. sind öffentlich und ohne Anmeldung zugänglich unter \href{https://github.com/wavelength-ide/wavelength-ide}{https://github.com/wavelength-ide/wavelength-ide}.
...
Der Übungsmodus wird durch Auswahl einer Übungsaufgabe betreten und durch Beendigung des Übungsmodus verlassen (vgl. \cref{fig:state}).\\
