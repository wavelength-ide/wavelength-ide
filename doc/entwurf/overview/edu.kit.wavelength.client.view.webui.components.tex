The \texttt{components}package contains different classes that make up the user interface (UI).
...
\texttt{\lnk{PopUpBox}}, \texttt{\lnk{TextField}}, \texttt{\lnk{VisualButton}} and \texttt{\lnk{WindowFocus}}.
