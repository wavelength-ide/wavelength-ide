	...
	public void factorial() throws ParseException {
		...
		for (int i = 0; i < 6; i++) {
			...
			LibraryTestUltilities.assertRepresents(j,
					LibraryTestUltilities.reduce(factorialProgramm + " " + i, libraries));
		}
