...
public interface Library extends Serializable {
	...
	/**
	 * Determines whether the library contains a {@link LambdaTerm} with the specified name.
	 * @param name The name to search the library for
	 * @return True if the library contains a {@link LambdaTerm} with the entered name
	 */
